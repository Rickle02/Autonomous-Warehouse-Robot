...
def main():
    ...
    while True:
        ...
        while not simulation_done:
            ...
            pickup_count_text = font.render(f"Pickup Point Items Waiting: {len(warehouse.pickup_queue)}", True,(0, 0, 0))
            live_items_text = font.render(f"Live Items in Shelves: {warehouse.count_live_items()}", True, (0, 0, 0))
            ...
            screen.blit(pickup_count_text, (cols * tile_size + 10, 140))
            screen.blit(live_items_text, (cols * tile_size + 10, 180))
